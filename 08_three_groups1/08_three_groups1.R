...
samples %>% 
	plyr::summarize(
		group1 = value[Parameter=='mu'] + value[Parameter=='diff1']*-.5 + value[Parameter=='diff2']*-.25
		, group2 = value[Parameter=='mu'] + value[Parameter=='diff1']*.5 + value[Parameter=='diff2']*-.25
		, group3 = value[Parameter=='mu'] + value[Parameter=='diff1']*0 + value[Parameter=='diff2']*.5
	) %>%
	plyr::summarize(
