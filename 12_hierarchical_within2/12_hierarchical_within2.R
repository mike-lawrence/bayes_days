...
#show that we (approximately) achieved the desired variance & correlation
print(mean(subject_parameters[,1]))
print(mean(subject_parameters[,2]))
print(sd(subject_parameters[,1]))
print(sd(subject_parameters[,2]))
print(cor(subject_parameters)[1,2])
